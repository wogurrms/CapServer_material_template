	...
	function drawBasic() {
		var jsonData = $.ajax({
			url : "${pageContext.request.contextPath}"
					+ "/userpage/chartFromRecordToJsonArray",
			dataType : "json",
			data : data,
			async : false
		}).responseText;
		...
		var event = google.visualization.events.addListener(chart, 'select',
				selectHandler);
		...
		function selectHandler() {
			...
			var dailyJsonData = $.ajax({
				url : "${pageContext.request.contextPath}"
						+ "/userpage/chartFromRecordToJsonArrayDaily/"
						+ requestData,
				type : "get",
				async : false
			}).responseText;
										...
										function() {
											...
											var chart = new google.visualization.ColumnChart(
													document
															.getElementById('chart_div'));
											chart.draw(data, options);
											var event = google.visualization.events
													.addListener(chart,
															'select',
															selectHandler);
